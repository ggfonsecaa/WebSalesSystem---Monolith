...
public interface IRepository<TEntity> where TEntity : Entity, IAggregateRoot
{
    ...
    public void DeleteRangeAsync(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default);
    ...
    public TEntity UpdateAsync(TEntity entity, CancellationToken cancellationToken = default);
    public TEntity UpdateByIdAsync(int id, CancellationToken cancellationToken = default);
    public IEnumerable<TEntity> UpdateRangeAsync(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default);
}